            ...
            <div className='container'>
                <div className={style.about_we}>
                    <div className={style.title}>
                        <h1 className={style.title_h1}>{lan === 'kaa' ? 'Bizler haqqinda' : 'О нас'}</h1>
                        {lan !== 'kaa' ?
                            ...
                            <p className={style.subtitle}>
                                MJ FAMILY - qolaylılıq gastronomiyalıq kónlikpelerdi ozinde jámlestiretuǵın orın. 2024-jılı qábiletli aspaz Murod Jalalatdinov tárepinen shólkemlestirilgen bul restoran shańaraq jıllılıǵı, tatlı dám hám minsiz xızmet tımsalına aylanǵan.
                            </p>
                        }
                    </div>
                    <div className={style.grid_container}>
                        ...
                        <div className={style.text}>
                            {lan !== 'kaa' ?
                                ...
                                :
                                <p>
                                    Biz dástúriy milliy taǵamlardı avtorlıq taǵamlardıń dúrdanaları menen birlestirip, hár bir awqattı shın mánisindegi lázzetke aylandıramız. Tek ǵana taza hám tábiyǵıy ónimler, tek ǵana eń jaqsı dám birikpeleri - hámmesi siz ushın. Solay eken hár bir demnen zawıqlanıń!
                                </p>
                            }
                        </div>
