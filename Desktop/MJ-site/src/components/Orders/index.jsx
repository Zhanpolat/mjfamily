...
const Orders = ({ color, handlColor, next, zanet }) => {

  const isZanetTrue = (index) => {
    for (let z of zanet) {
      if (z === `${index}`) {
        return true;
      }
      ...
      <div className={style.common}>
        <div>
          <div className={style.six}>
            <div onClick={() => isZanetTrue(6) ? '' : handlColor(6)} className={`${color === 6 ? style.green : ''} ${isZanetTrue(6) ? style.color : ''}`}>
            ...
            <p className={style.text} style={{ color: isZanetTrue(6) ? 'red' : '' }}>{isZanetTrue(6) ? 'Забронировано' : ''}</p>
          </div>
          <div>
            <div>
              <div className={style.eleven}>
                <div onClick={() => isZanetTrue(11) ? '' : handlColor(11)}
                  className={`${color === 11 ? style.green : ''} ${isZanetTrue(11) ? style.color : ''}`}>
                ...
                <p className={style.text} style={{ color: isZanetTrue(11) ? 'red' : '' }}>{isZanetTrue(11) ? 'Забронировано' : ' '}</p>
              </div>
              <div className={style.twelf}>
                <div>
                  <div onClick={() => isZanetTrue(12) ? '' : handlColor(12)}
                    className={`${color === 12 ? style.green : ''} ${isZanetTrue(12) ? style.color : ''}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="83" height="114" viewBox="0 0 83 114" fill="none">
                      <mask id="path-1-inside-1_295_2668" fill="white">
                        <rect y="15.5385" width="82.9231" height="82.9231" rx="2" />
                      </mask>
                  ...
                  <p className={style.text} style={{ color: isZanetTrue(12) ? 'red' : '' }}>{isZanetTrue(12) ? 'Забронировано' : ''}</p>
                </div>
              </div>
            </div>
            <div className={style.four}>
              <div>
                <div onClick={() => isZanetTrue(7) ? '' : handlColor(7)}
                  className={`${color === 7 ? style.green : ''} ${isZanetTrue(7) ? style.color : ''}`}>
                ...
                <p className={style.text} style={{ color: isZanetTrue(7) ? 'red' : '' }}>{isZanetTrue(7) ? 'Забронировано' : ' '}</p>
              </div>
              <div>
                <div onClick={() => isZanetTrue(8) ? '' : handlColor(8)}
                  className={`${color === 8 ? style.green : ''} ${isZanetTrue(8) ? style.color : ''}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="114" height="114" viewBox="0 0 136 134" fill="none">
                    <mask id="path-1-inside-1_347_2630" fill="white">
                      <rect x="19" y="18" width="98" height="98" rx="2" />
                    </mask>
                ...
                <p className={style.text} style={{ color: isZanetTrue(8) ? "red" : '' }}>{isZanetTrue(8) ? 'Забронировано' : ''}</p>
              </div>
              <div>
                <div onClick={() => isZanetTrue(9) ? '' : handlColor(9)}
                  className={`${color === 9 ? style.green : ''} ${isZanetTrue(9) ? style.color : ''}`}>
                ...
                <p className={style.text} style={{ color: isZanetTrue(9) ? 'red' : '' }}>{isZanetTrue(9) ? 'Забронировано' : ''}</p>
              </div>
              <div>
                <div onClick={() => isZanetTrue(10) ? '' : handlColor(10)}
                  className={`${color === 10 ? style.green : ''} ${isZanetTrue(10) ? style.color : ''}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="100" height="116" viewBox="0 0 90 94" fill="none">
                    <path d="M72.873 32.1548H84.127C84.5237 32.1548 84.8452 32.4763 84.8452 32.873V61.127C84.8452 61.5237 84.5237 61.8452 84.127 61.8452H72.873C72.4763 61.8452 72.1548 61.5237 72.1548 61.127V32.873C72.1548 32.4763 72.4763 32.1548 72.873 32.1548Z" fill="white" stroke="#CECECE" stroke-width="4.30953" />
                    <path d="M24.8189 6.58052L32.2472 15.0346C32.509 15.3326 32.4797 15.7865 32.1817 16.0483L10.957 34.6976C10.659 34.9595 10.2052 34.9301 9.94332 34.6321L2.51502 26.178C2.25319 25.88 2.2825 25.4262 2.58049 25.1644L23.8052 6.51505C24.1032 6.25322 24.557 6.28253 24.8189 6.58052Z" fill="white" stroke="#CECECE" stroke-width="4.30953" />
                    <path d="M13.0163 80.9991L16.9133 70.4414C17.0507 70.0693 17.4637 69.879 17.8359 70.0163L44.3418 79.8001C44.7139 79.9375 44.9043 80.3505 44.7669 80.7226L40.8699 91.2803C40.7325 91.6525 40.3195 91.8428 39.9473 91.7054L13.4414 81.9217C13.0693 81.7843 12.879 81.3713 13.0163 80.9991Z" fill="white" stroke="#CECECE" stroke-width="4.30953" />
                ...
                <p className={style.text} style={{ color: isZanetTrue(10) ? "red" : '' }}>{isZanetTrue(10) ? 'Забронировано' : ''}</p>
              </div>
            </div>
          </div>
        </div>
        <div className={style.five}>
          <div>
            <div onClick={() => isZanetTrue(1) ? '' : handlColor(1)}
              className={`${color === 1 ? style.green : ''} ${isZanetTrue(1) ? style.color : ''}`}>
              <svg xmlns="http://www.w3.org/2000/svg" width="114" height="114" viewBox="0 0 136 134" fill="none">
                <mask id="path-1-inside-1_347_2630" fill="white">
                  <rect x="19" y="18" width="98" height="98" rx="2" />
                </mask>
            ...
            <p className={style.text} style={{ color: isZanetTrue(1) ? 'red' : '' }}>{isZanetTrue(1) ? 'Забронировано' : ''}</p>
          </div>
          <div>
            <div onClick={() => isZanetTrue(2) ? '' : handlColor(2)}
              className={`${color === 2 ? style.green : ''}  ${isZanetTrue(2) ? style.color : ''}`}>
              <svg xmlns="http://www.w3.org/2000/svg" width="114" height="114" viewBox="0 0 136 134" fill="none">
                <mask id="path-1-inside-1_347_2630" fill="white">
                  <rect x="19" y="18" width="98" height="98" rx="2" />
                </mask>
            ...
            <p className={style.text} style={{ color: isZanetTrue(2) ? 'red' : '' }}>{isZanetTrue(2) ? 'Забронировано' : ''}</p>
          </div>
          <div>
            <div onClick={() => isZanetTrue(3) ? '' : handlColor(3)}
              className={`${color === 3 ? style.green : ''} ${isZanetTrue(3) ? style.color : ''}`}>
              <svg xmlns="http://www.w3.org/2000/svg" width="114" height="114" viewBox="0 0 136 134" fill="none">
                <mask id="path-1-inside-1_347_2630" fill="white">
                  <rect x="19" y="18" width="98" height="98" rx="2" />
                </mask>
            ...
            <p className={style.text} style={{ color: isZanetTrue(3) ? 'red' : '' }}>{isZanetTrue(3) ? 'Забронировано' : ''}</p>
          </div>
          <div>
            <div onClick={() => isZanetTrue(4) ? '' : handlColor(4)}
              className={`${color === 4 ? style.green : ''} ${isZanetTrue(4) ? style.color : ''}`}>
            ...
            <p className={style.text} style={{ color: isZanetTrue(4) ? 'red' : '' }}>{isZanetTrue(4) ? 'Забронировано' : ''}</p>
          </div>
          <div>
            <div onClick={() => isZanetTrue(5) ? '' : handlColor(5)}
              className={`${color === 5 ? style.green : ''} ${isZanetTrue(5) ? style.color : ''}`}>
              <svg xmlns="http://www.w3.org/2000/svg" width="114" height="145" viewBox="0 0 144 189" fill="none">
                <mask id="path-1-inside-1_346_2638" fill="white">
                  <rect x="19" y="19" width="106" height="150" rx="2" />
                </mask>
            ...
            <p className={style.text} style={{ color: isZanetTrue(5) ? 'red' : "" }}>{isZanetTrue(5) ? 'Забронировано' : ''}</p>
          </div>
        </div>
      </div>
    </div >
