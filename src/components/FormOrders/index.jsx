...
export const handleSubmit = async (e, setModal, dispatch, formData, setFormData, getOrders) => {
    e.preventDefault();
...
const FormOrders = ({ cabinTableId, setPlace, title, setModal, setNext, next, setShowHide, formData, setFormData, setData, getOrders, setIsDisabledMini, isDisabledMini }) => {
    ...
    const handleData = (e, name) => {
        ...
        const [datePart, timePart] = newData.split("T");
        const [year, month, day] = datePart.split("-");
        const formattedData = `${day}.${month}.${year} ${timePart}`;
        byTheWay(e, name, formattedData)
    }

    const byTheWay = (e, name, formattedData) => {
        setFormData({ ...formData, [e.target.name]: formattedData });
    }
            ...
            {name === 'startDate' || name === 'endDate' ?
                <div>
                    ...
                    <input
                        ...
                        name={name}
                        value={formData[name]}
                        onChange={name === 'startDate' || name === 'endDate' ? (e) => handleData(e, name) : handleChange}
